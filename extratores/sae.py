...
def extrair_sae(caminho_txt):
    ...
    # Resíduo genérico (ex: SERVIÇO BÁSICO ÁGUA) — não é SMRSU, é "qualquer
    # outra coisa que não água/esgoto". Ver VALOR_OUTRAS_TAXAS em
    # pipeline.py: nunca é zerada por flag do contas.json.
